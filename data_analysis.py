...
def plot_histogram(save_dir=d):
    plt.figure(figsize=(10, 6))
    sns.histplot(data=df, x="magnitude", hue="region",
                 bins=10, multiple="stack", palette="tab10")
...
def plot_line(save_dir=d, freq="D"):
...
def plot_scatter(x_col, y_col, save_name, save_dir=d):
    plt.figure()
